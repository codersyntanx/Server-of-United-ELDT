...
function createApplePayTransaction(callback) {
    ...
    // Assuming you receive the Apple Pay data from the client and store it in request.body.applePayData
    var applePayData = request.body.applePayData;

    var opaqueData = new ApiContracts.OpaqueDataType();
    opaqueData.setDataDescriptor('COMMON.APPLE.INAPP.PAYMENT');
    opaqueData.setDataValue(applePayData);
